...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "universe", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "universe", null, { width: 600, height: 900 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 600, height: 900 });
			#end
