...
Void FontDebugger_obj::__construct(::String __o_filename,::openfl::text::FontStyle style,::openfl::text::FontType type)
{
...
hx::ObjectPtr< FontDebugger_obj > FontDebugger_obj::__new(::String __o_filename,::openfl::text::FontStyle style,::openfl::text::FontType type)
