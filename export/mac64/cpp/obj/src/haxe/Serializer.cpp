...
::String Serializer_obj::toString( ){
	HX_STACK_FRAME("haxe.Serializer","toString",0x95bdfda0,"haxe.Serializer.toString","/usr/lib/haxe/std/haxe/Serializer.hx",116,0x34aceec4)
	HX_STACK_THIS(this)
	HX_STACK_LINE(116)
...
{
		HX_STACK_FRAME("haxe.Serializer","serializeString",0xd565bc5d,"haxe.Serializer.serializeString","/usr/lib/haxe/std/haxe/Serializer.hx",150,0x34aceec4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(151)
...
bool Serializer_obj::serializeRef( Dynamic v){
	HX_STACK_FRAME("haxe.Serializer","serializeRef",0x0b8ed647,"haxe.Serializer.serializeRef","/usr/lib/haxe/std/haxe/Serializer.hx",169,0x34aceec4)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(173)
	{
...
{
		HX_STACK_FRAME("haxe.Serializer","serializeFields",0x44c42205,"haxe.Serializer.serializeFields","/usr/lib/haxe/std/haxe/Serializer.hx",206,0x34aceec4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(207)
		{
...
{
		HX_STACK_FRAME("haxe.Serializer","serialize",0x3cea866c,"haxe.Serializer.serialize","/usr/lib/haxe/std/haxe/Serializer.hx",225,0x34aceec4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(225)
		{
...
::String Serializer_obj::run( Dynamic v){
	HX_STACK_FRAME("haxe.Serializer","run",0xcdbeded7,"haxe.Serializer.run","/usr/lib/haxe/std/haxe/Serializer.hx",526,0x34aceec4)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(527)
