...
::String Bytes_obj::getString( int pos,int len){
	HX_STACK_FRAME("haxe.io.Bytes","getString",0xa16beae4,"haxe.io.Bytes.getString","/usr/lib/haxe/std/haxe/io/Bytes.hx",261,0x9329f754)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pos,"pos")
	HX_STACK_ARG(len,"len")
	HX_STACK_LINE(263)
...
::String Bytes_obj::toString( ){
	HX_STACK_FRAME("haxe.io.Bytes","toString",0x0291226f,"haxe.io.Bytes.toString","/usr/lib/haxe/std/haxe/io/Bytes.hx",335,0x9329f754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(335)
