...
{
		HX_STACK_FRAME("haxe.io.Output","close",0xe726bfeb,"haxe.io.Output.close","/usr/lib/haxe/std/haxe/io/Output.hx",68,0xbdd9ff1c)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("haxe.io.Output","writeFullBytes",0xc2c420ea,"haxe.io.Output.writeFullBytes","/usr/lib/haxe/std/haxe/io/Output.hx",90,0xbdd9ff1c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_ARG(pos,"pos")
		HX_STACK_ARG(len,"len")
...
{
		HX_STACK_FRAME("haxe.io.Output","writeString",0x97e1cb83,"haxe.io.Output.writeString","/usr/lib/haxe/std/haxe/io/Output.hx",313,0xbdd9ff1c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(317)
