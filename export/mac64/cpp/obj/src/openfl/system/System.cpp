...
int code = __o_code.Default(0);
	HX_STACK_FRAME("openfl.system.System","exit",0xa31a52fc,"openfl.system.System.exit","openfl/system/System.hx",16,0xde21ad4e)
	HX_STACK_ARG(code,"code")
{
		HX_STACK_LINE(16)
		::openfl::Lib_obj::close();
	}
return null();
}
...
Void System_obj::gc( ){
{
		HX_STACK_FRAME("openfl.system.System","gc",0x9ae3627a,"openfl.system.System.gc","openfl/system/System.hx",26,0xde21ad4e)
		HX_STACK_LINE(26)
...
::String System_obj::get_deviceID( ){
	HX_STACK_FRAME("openfl.system.System","get_deviceID",0xd35b0bd8,"openfl.system.System.get_deviceID","openfl/system/System.hx",43,0xde21ad4e)
	HX_STACK_LINE(43)
	return ::openfl::system::System_obj::lime_get_unique_device_identifier();
}
...
int System_obj::get_totalMemory( ){
	HX_STACK_FRAME("openfl.system.System","get_totalMemory",0x85540a5e,"openfl.system.System.get_totalMemory","openfl/system/System.hx",51,0xde21ad4e)
	HX_STACK_LINE(51)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.system.System"), hx::TCanCast< System_obj> ,sStaticFields,sMemberFields,
...
{
	lime_get_unique_device_identifier= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_get_unique_device_identifier"),(int)0);
}
